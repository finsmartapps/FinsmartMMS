...
interface Props {
  ...
  todayDate: string   // YYYY-MM-DD — never navigate past this
}

export function ManagerDateNav({ activeDate, todayDate }: Props) {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <div className="relative">
        ...
        />
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg hover:bg-[#F5F5F7] transition cursor-pointer select-none text-[12px] font-medium text-[#6E6E73] border border-[#E5E5EA]">
