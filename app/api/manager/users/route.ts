...
export async function POST(req: NextRequest) {
  ...
  if (!has_sales && !has_marketing && !has_expenses && !has_warehouse && !has_advocacy && !has_ms_social)
...
export async function PATCH(req: NextRequest) {
  ...
  for (const key of ['has_sales', 'has_marketing', 'has_expenses', 'has_warehouse', 'has_advocacy', 'has_ms_social'] as const) {
